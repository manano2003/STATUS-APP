...
export default function HistoryShelterCalendar() {
  ...
  const goToDay = (day: number) => {
    ...
    navigate(`/dashboard/history/shelters/${shelter.id}/${dateStr}`)
  }

  return (
    <PageLayout title={shelter.name} subtitle={`מקלט ${shelter.number} — היסטוריה`} backTo="/dashboard/history/shelters">
